  ...
  {//прописать стили внутри рендера
    ...
    render: () => <Container fluid >
      <Tab.Pane style={sizeTab} >
        <Grid>
          <Grid.Column width={9}>
            <Image style={immortalIcon1} verticalAlign='middle' size="tiny" src={iconImmortal} />
            ...
            <Link to="/boost">
              <Button compact color='purple' size="large" attached="left" >
          ...
          <Grid.Column width={7}>
            <Image style={igameStyle} size="large" src={immortal} />
          </Grid.Column>
        </Grid>
  ...
  },
  {
    ...
    render: () => <Container>
      <Tab.Pane style={sizeTab}>
        <Grid>
          <Grid.Column width={9}>
            <Image verticalAlign='middle' size="tiny" src={iconImmortal2} />
            ...
            <Link to="/boost">
              <Button style={{ top: "10%" }} compact color='purple' size="large" attached="left">
          ...
          <Grid.Column width={7}>
            <Image style={igameStyle} floated="right" size="large" src={immortal2} />
          </Grid.Column>
        </Grid>
      </Tab.Pane>
    </Container>
      ...
      <Tab.Pane style={sizeTab}>
        <Grid>
          <Grid.Column width={9}>
            ...
            <Link to="/accounts">
              <Button style={{ top: "10%" }} icon="angle double right" compact color='purple' size="large" attached="left">
                КУПИТЬ АККАУНТ
                <Icon size="large" name="angle double right" />
              </Button>
            </Link>
          ...
          <Grid.Column width={7}>
            <Image style={igameStyle} floated="right" size="large" src={immortal3} />
          </Grid.Column>
        </Grid>
      </Tab.Pane>,
    </Container>
      ...
      <Tab.Pane style={sizeTab}>
        <Grid >
          <Grid.Column width={9}>
            ...
            <Link to="/boost">
              <Button style={{ top: "5%" }} compact color='purple' size="large" attached="left" icon="share" >
          ...
          <Grid.Column width={7}>
            <Image style={igameStyle} floated="right" size="large" src={immortal4} />
          </Grid.Column>
        </Grid>
...
const TabExamplePointing = () => <Container textAlign="center"> <Tab menu={menu} panes={panes} /> </Container>
